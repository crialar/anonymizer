...
SAFE_REGEX_TITLED_NAME_PATTERNS = [
    r"\b(?:Dr|Dra|Prof|Professor|Doctor|Doctora)\.?\s+[A-ZÀ-ÿ][a-zÀ-ÿ]+(?:\s+[A-ZÀ-ÿ][a-zÀ-ÿ]+){0,3}\b",
    ...
    r"\b(?:Principal\s+Investigator|Sub-?[Ii]nvestigator|Study\s+Coordinator|Site\s+Director|Medical\s+Monitor|Study\s+Physician|Investigador\s+Principal)[\s:]+[A-ZÀ-ÿ][a-zÀ-ÿ]+(?:\s+[A-ZÀ-ÿ][a-zÀ-ÿ]+){0,2}\b",
    r"\b(?:PI|Co-?PI|SI)[\s:]+[A-ZÀ-ÿ][a-zÀ-ÿ]+(?:\s+[A-ZÀ-ÿ][a-zÀ-ÿ]+){0,2}\b",
]
