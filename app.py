...
def generate_clean_tmx(previews: dict, results: dict, originals: dict,
                       ...
                       excluded_segments: dict, no_anon_segments: dict) -> tuple:
    ...
    return result, valid_count, no_anon_skipped, excluded_ids
...
def main():
    ...
    with tab3:
        if "results" in st.session_state and st.session_state.results:
            ...
            clean_tmx_data, valid_segments, no_anon_in_tmx, excluded_ids = generate_clean_tmx(
                previews=previews,
