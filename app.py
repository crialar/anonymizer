        ...
        if "results" in st.session_state and st.session_state.results:
            ...
            if not dedup_tmx:
                ...
                if not conflict_groups:
                    ...
                    st.markdown(f"<small>Segments with the same source but different translations. Select which translation to keep in each match.</small>", unsafe_allow_html=True)
