...
def main():
    ...
    <div style="background: linear-gradient(135deg, #1a5488 0%, #0e7bc0 100%); 
        ...
        <p style="color: rgba(255,255,255,0.9) !important; margin: 0.5rem 0 0 0; font-size: 1.1rem;">
            Anonymize & clean bilingual memoQ documents (EN > ES)
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with tab3:
        if "results" in st.session_state and st.session_state.results:
            ...
            render_stat_card("Proper Names", total_stats["proper_names"], col5)
            render_stat_card("Dictionary", total_stats["dictionary"], col6)
